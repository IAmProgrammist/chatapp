...
public class Connection implements Closeable, Serializable {
    ...
    private static String ip = "37.230.114.103";
    //"192.168.1.39" for local tests
    //"37.230.114.103" for global release
    ...
    public List<Room> recieveRooms() throws IOException, JSONException {
            ...
            if (isOnline() && check(ip, 2156)) {
                ...
                if (MessageType.valueOf(String.valueOf(json.get("type"))) == MessageType.HISTORY) {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        tmpMessage.setDate(array.getJSONObject(i).getLong("date"));
